...
public class ProgressBarThread3 extends Thread {
    ...
    public ProgressBarThread3(List<Map<String, Object>> list,MyAdpter myAdpter,ArrayList<PCB> arraylist,ProgressActivity ProgressActivity) {
    ...
    public void run() {
        ...
        while (end == 0) {
            ...
            while (arraylistTemp.get(runNum).time != 0) {
                ...
                map2.put("sign",  "进程标记符:"+arraylistTemp.get(runNum).name);
